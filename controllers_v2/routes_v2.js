...
// controllers
var dataTransferCtrl = require('../controllers_v2/for_data_transfer.js')
...
module.exports = function (app, webEntry, acl) {
  ...
  // csq
  app.post(version + '/dataTransfer', dataTransferCtrl.setRoles)
  app.post(version + '/acl/userRoles', aclsettingCtrl.addUserRoles(acl), alluserCtrl.changerole)
