...
var personalDiagSchema = new mongoose.Schema({
  ...
  endTime: Date, // 面诊过期时间
  time: Date, // 面诊确认时间
  status: {type: Number, default: 0, enum: [0, 1, 2, 3, 4, 5, 6, 7]} // 面诊状态 0: 待核销，1: 医生完成核销，2: 过期自动核销，3: 患者取消，直接退款，4: 医生停诊或取消，直接退款，5: 患者申请取消，等待人工处理退款，6: 医生停诊或取消，等待人工通知，7:患者取消，人工处理不予退款，8:患者取消，人工退款，9：医生停诊或取消，人工通知完成
})
